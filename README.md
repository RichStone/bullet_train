...
You can head over to [the Bullet Train Kamal deployment guide](https://richstone.io/rails-8-on-kamal-example-setup-with-sidekiq-redis-and-postgres) to deploy your app on Kamal.
